...
public class SkyblockOverworldChunkGenerator extends NoiseBasedChunkGenerator {
    ...
    public SkyblockOverworldChunkGenerator(Registry<NormalNoise.NoiseParameters> noises, BiomeSource provider, long seed, Supplier<NoiseGeneratorSettings> generatorSettings) {
        ...
        this.parent = new NoiseBasedChunkGenerator(this.noises, provider, seed, generatorSettings);
    ...
    public ChunkGenerator withSeed(long seed) {
        return new SkyblockOverworldChunkGenerator(this.noises, this.biomeSource.withSeed(seed), seed, this.generatorSettings);
    }
